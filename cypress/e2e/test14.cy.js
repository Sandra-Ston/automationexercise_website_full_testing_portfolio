...
describe("Test Case 14: Place Order: Register while Checkout", () => {
  it("", () => {
    ...
    cy.get("#address_delivery").should("contain.text", "Mr. Alice Enough");
    cy.get("#address_delivery").should("contain.text", "Test Company");
    ...
    cy.get("#address_invoice").should("contain.text", "Mr. Alice Enough");
    ...
    cy.get(".form-control").type("Please deliver between 9 AM - 5 PM.");
